## Purpose
Define backend diagnostic logging behavior, including local persistence, bounded retention, default verbosity, opt-in debug logging, and sensitive data protections.
